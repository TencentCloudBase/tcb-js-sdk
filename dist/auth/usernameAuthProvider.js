...
var UsernameAuthProvider = (function (_super) {
    ...
    UsernameAuthProvider.prototype.signIn = function (username, password) {
        return __awaiter(this, void 0, void 0, function () {
            var refreshTokenKey, res, refresh_token, access_token_expire, access_token;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this._request.send('auth.signIn', {
                                loginType: base_1.LOGINTYPE.USERNAME,
                                username: username,
                                password: password,
                    ...
                    case 1:
                        ...
                        if (!refresh_token) return [3, 6];
                        this.setRefreshToken(refresh_token);
                        if (!(access_token && access_token_expire)) return [3, 2];
                        this.setAccessToken(access_token, access_token_expire);
                        return [3, 4];
                    case 2: return [4, this._request.refreshAccessToken()];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [4, this.refreshUserInfo()];
                    case 5:
                        _a.sent();
