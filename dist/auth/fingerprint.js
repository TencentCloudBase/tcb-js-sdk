...
promise.then().catch();
function getTcbFingerprintId() {
    return __awaiter(this, void 0, void 0, function () {
        var storageClass, id, e_1, isLocal;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    storageClass = (adapters_1.Adapter.adapter && adapters_1.Adapter.adapter.localStorage) || null;
                    if (storageClass) {
...
exports.getTcbFingerprintId = getTcbFingerprintId;
